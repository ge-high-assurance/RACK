...
def test_load_csv(rack_in_a_box: str) -> None:
    ...
    ingest_data_driver(Path("../models/TurnstileSystem/Data/import.yaml"), Url(rack_in_a_box), None, None, False)

def test_load_owl(rack_in_a_box: str) -> None:
    # Just test that it doesn't raise an exception
    ingest_owl_driver(Path("../OwlModels/import.yaml"), Url(rack_in_a_box), None, False)
