...
assist_done_dialog = dbc.Modal(
    [
        ...
        dbc.ModalFooter(html.Button("Close", id="assist-done-dialog-button", n_clicks=0)),     # close button
    ],
...
layout = html.Div(children=[
    ...
    html.Button("Verify data", id="assist-button"),  # run ASSIST button
...
def run_assist(status_filepath):
    ...
    return [dcc.Markdown("Done"), dcc.Markdown("TODO: Link to full output")]
