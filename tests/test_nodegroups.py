...
def test_invariant_nodegroups(rack_url: str) -> None:
    ...
    semtk3.SEMTK3_CONN_OVERRIDE = rack.sparql_connection(rack.Url(rack_url), rack.DEFAULT_DATA_GRAPH, [], None)
...
def test_query_nodegroups(rack_url: str) -> None:
    conn = rack.sparql_connection(rack.Url(rack_url), rack.DEFAULT_DATA_GRAPH, [], None)
